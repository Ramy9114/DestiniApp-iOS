...
//    let stories: [Story] = [Story(story: "You see a fork on the road.", choice1: "Take a left", choice2: "Take a right"),
...
//    ]
    ...
    mutating func nextStory(_ userChoice: String) -> Story {
        if userChoice == stories[self.storyNumber].choice1{
            self.storyNumber = stories[self.storyNumber].choice1Destination
            return stories[self.storyNumber]
        } else if userChoice == stories[self.storyNumber].choice2{
            self.storyNumber = stories[self.storyNumber].choice2Destination
            return stories[self.storyNumber]
        }
        return Story(title: "", choice1: "", choice1Destination: 0, choice2: "", choice2Destination: 0)
    }
